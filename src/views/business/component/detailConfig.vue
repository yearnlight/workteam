                    ...
                    <div class="module-content">
                        ...
                        <el-form-item label="基本详情配置" class="detailConfig" prop="tableColumns">
                            ...
                            <div class="columns-header">
                                <div class="columns-header-item">对应属性</div>
                                <div class="columns-header-item">对应名称</div>
                                <div class="columns-header-item miniWidth">是否开启Tooltip</div>
                                <div class="columns-header-item miniWidth">设置为枚举列</div>
                                <div class="columns-header-item miniWidth" v-if="module.fields.some(s => s.isEnum)">枚举列配置</div>
                            </div>
                            <!-- 详情 -->
                            <div class="columns" v-for="(item,index) in module.fields" :key="index">
