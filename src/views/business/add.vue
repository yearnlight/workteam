<template>
  <div class="generate">
    <el-form ref="setForm" label-suffix="：" :model="setData" :rules="rules" size="small" label-width="180px">
          ...
          <el-form-item label="表格列配置" label-width="110px" class="tableConfig" prop="tableColumns">
            <div class="columns">
              ...
              <div class="columns-item">
                ...
                <div class="columns-item-node miniWidth" v-if="isConfigInfo">
                  <div class="header">详情入口回调方法名</div>
                </div>
                <div class="columns-item-node miniWidth">
                  <div class="header">设置为操作列</div>
                </div>
                <div class="columns-item-node miniWidth" v-if="isConfigOperate">
                  <div class="header">操作列配置</div>
                </div>
                <div class="columns-item-node miniWidth">
                  <div class="header">设置为枚举列</div>
                </div>
                <div class="columns-item-node miniWidth" v-if="isConfigEnum">
      ...
      <detail ref="detail" :columns="setData.tableColumns" v-show="setData.type == 'info'" />
    ...
    return {
      setData: {
        ...
        tableColumns: [
          ...
          {
            prop: "status", label: "状态", width: "100", "isEnum": true,
            "enums": {
              "active": {
                "label": "应用",
                "type": "success",
